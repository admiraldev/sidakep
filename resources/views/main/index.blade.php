...
<head>
    ...
    <!-- MDB -->
    <link rel="stylesheet" href="assets/mdl/css/mdb.min.css" />
    <!-- Custom styles -->
    <link rel="stylesheet" href="assets/mdl/css/style.css" />
</head>
<body>
    <!--Main Navigation-->
    <header>
    ...
    <!--Footer-->
    @include('f-layout.footer');
    <!--Footer-->
  
    <!-- MDB -->
    <script type="text/javascript" src="assets/mdl/js/mdb.min.js"></script>
    <!-- Custom scripts -->
    <script type="text/javascript" src="assets/mdl/js/script.js"></script>
</body>
</html>